/* 
	...
	**For use with NON-stream enabled bootloader only**
*/
...
MEMORY
{
  ...
  text   (rx)       : ORIGIN = 0x8010, LENGTH = 0x6f90 /* END=0xefa0, size of 27.89k */
  uservectors (rx)	: ORIGIN = 0xefa0, LENGTH = 0x0040 /* END=0xefe0, length of 64 to handle 4 bytes per interrupt, which allows "br" plus address */
  vectors (rw)      : ORIGIN = 0xefe0, LENGTH = 0x0020 /* END=0xf000, put gcc generated vector table here, won't be used by code but addresses will be used during interrupt revectoring step */
